 ...
 *
 * Description: This function sorts a bitonic sequence
 ...
 *
 * Description: This function converts an array of integers
 ...
 *              It prints the array after each swap. Note that this
 *              function only works for sizes that are powers of 2.
 */
void bitonic_sort(int *array, size_t size)
{
